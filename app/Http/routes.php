...
Route::match(['put', 'post'], 'DoctorController@edit_doctor');
Route::match(['get', 'delete'], 'DoctorController@delete_doctor');
...
Route::match(['get', 'delete'], 'AppointmentController@delete_appointment');
